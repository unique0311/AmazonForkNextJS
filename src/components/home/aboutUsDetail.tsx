  ...
  return (
    <div className="aboutDetail_container">
      ...
      <h5>
        ...
        <br />
        <br />
        Discover the difference with Discount Donkey—your trusted ally in the ever-evolving landscape of Amazon UK
