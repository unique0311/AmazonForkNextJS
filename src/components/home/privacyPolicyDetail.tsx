  ...
  return (
    <div className="privacyPolicy_container">
      ...
      <p>
        ...
        <ul>
          <li>
            To provide and maintain the Website <br />
          </li>
          ...
          <li>
            To provide analysis or valuable information so that we can improve the Website <br />
          </li>
          <li>
            To monitor the usage of the Website <br />
          </li>
      ...
      <p>
        <ul>
          ...
          <li>
            To protect and defend the rights or property of Discount Donkey <br />
          </li>
          <li>
          ...
          <li>
            To protect the personal safety of users of the Website or the public <br />
          </li>
